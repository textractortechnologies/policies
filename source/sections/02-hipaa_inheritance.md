...
## 2.1 HIPAA Inheritance for Textractor Customers

| **Administrative Controls** HIPAA Rule | Textractor Control | Inherited
--- | --- | ---
...
| **Physical Safeguards** HIPAA Rule | Textractor Control | Inherited
--- | --- | ---
...
| **Technical Safeguards** HIPAA Rule | Textractor Control | Inherited
--- | --- | ---
...
| **Organizational Requirements** HIPAA Rule | Textractor Control | Inherited
--- | --- | ---
...
| **Policies and Procedures and Documentation Requirements** HIPAA Rule | Textractor Control | Inherited
--- | --- | ---
...
| **HITECH Act - Security Provisions** HIPAA Rule | Textractor Control | Inherited
--- | --- | ---
